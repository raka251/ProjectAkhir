...
<html>
<head>
<title>LAKSANA SPORTS - Konfirmasi Pembayaran</title>
<!-- for-mobile-apps -->
			...
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						...
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">rakawiji.krisnaya@gmail.com</a></li>
